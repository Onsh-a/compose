...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    const chord1 = new (0, _chordDefault.default)();
    ...
    const main = ()=>{
        ...
        chordKyboard.renderKeyboard(chord1.calcChord(scaleClass.root));
        printScaleTable(scale1);
        printDiatonicChords(chord1.calcDiatonic(scale1, scaleClass.scaleType));
        printChordApplicatures();
        keyboard.setIsSharp(scaleClass.isSharp);
        chordKyboard.setIsSharp(scaleClass.isSharp);
        chord1.setIsSharp(scaleClass.isSharp);
