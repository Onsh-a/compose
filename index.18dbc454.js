...
var _romanizeNumbersJs = require("./helpers/romanizeNumbers.js");
var _romanizeNumbersJsDefault = parcelHelpers.interopDefault(_romanizeNumbersJs);
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const main = ()=>{
        ...
        decideOnDiatonic(scale1, settings.scale);
    ...
    const decideOnDiatonic = (scale, diatonicPattern)=>{
        ...
        scale.forEach((item, index)=>{
            if (pattern.includes(index)) return diatonicChords.push({
                chord: item,
                step: (0, _romanizeNumbersJsDefault.default)(index + 1)
            });
            basicChords.push({
                chord: item,
                step: (0, _romanizeNumbersJsDefault.default)(index + 1)
    ...
    const setChordApplicatures = ()=>{
        ...
        chords.forEach((item)=>{
            item.addEventListener("click", (e)=>{
                chordField.innerHTML = `${e.target.innerText} = ${(0, _makeChordsDefault.default)(e.target.innerText)}`;
            // renderChordShape();
            });
        });
    };
...
},{"./helpers/romanizeNumbers.js":"gsCYk","./helpers/makeChords":"cFDBd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./helpers/customSelect":"4vWz9"}],"gsCYk":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"cFDBd":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const notes = [
    "C",
...
parcelHelpers.defineInteropFlag(exports);
const initSelect = ()=>{
    const selected1 = document.querySelectorAll(".selected");
