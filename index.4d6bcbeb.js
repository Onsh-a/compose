...
(0, _vue.createApp)((0, _appVueDefault.default)).use((0, _routerDefault.default)).mount("#root");

},{"vue":"gzxs9","./router":"l7a58","./App.vue":"fYNyc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gzxs9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
function reload(id, newComp) {
    ...
    for (const instance1 of instances){
        ...
        } else if (instance1.parent) // 4. Force the parent instance to re-render. This will cause all updated
...
function devtoolsInitApp(app, version1) {
    emit("app:init" /* DevtoolsHooks.APP_INIT */ , app, version1, {
        Fragment,
        Text,
        Comment,
        Static
...
function applyOptions(instance) {
    ...
    if (methods) for(const key4 in methods){
        ...
        if ((0, _shared.isFunction)(methodHandler)) {
            ...
            checkDuplicateProperties("Methods" /* OptionTypes.METHODS */ , key4);
    ...
    if (computedOptions) for(const key2 in computedOptions){
        ...
        checkDuplicateProperties("Computed" /* OptionTypes.COMPUTED */ , key2);
    }
    ...
    process (n1, n2, container2, anchor2, parentComponent, parentSuspense, isSVG, slotScopeIds, optimized, internals) {
        ...
        if (n1 == null) {
            ...
            if (disabled) {
                ...
                moveTeleport(n2, container2, mainAnchor, internals, 1 /* TeleportMoveTypes.TOGGLE */ );
            } else {
                // target changed
...
function trigger(target, type, key1, newValue, oldValue, oldTarget) {
    ...
    else if (key1 === "length" && (0, _shared.isArray)(target)) {
...
function createGetter(isReadonly1 = false, shallow = false) {
    return function get(target, key, receiver) {
        if (key === "__v_isReactive" /* ReactiveFlags.IS_REACTIVE */ ) return !isReadonly1;
        else if (key === "__v_isReadonly" /* ReactiveFlags.IS_READONLY */ ) return isReadonly1;
        else if (key === "__v_isShallow" /* ReactiveFlags.IS_SHALLOW */ ) return shallow;
        else if (key === "__v_raw" /* ReactiveFlags.RAW */  && receiver === (isReadonly1 ? shallow ? shallowReadonlyMap : readonlyMap : shallow ? shallowReactiveMap : reactiveMap).get(target)) return target;
        ...
        if (!isReadonly1) track(target, "get" /* TrackOpTypes.GET */ , key);
...
function size(target, isReadonly4 = false) {
    target = target["__v_raw" /* ReactiveFlags.RAW */ ];
    !isReadonly4 && track(toRaw(target), "iterate" /* TrackOpTypes.ITERATE */ , ITERATE_KEY);
...
function createForEach(isReadonly5, isShallow2) {
    return function forEach(callback, thisArg) {
        ...
        !isReadonly5 && track(rawTarget, "iterate" /* TrackOpTypes.ITERATE */ , ITERATE_KEY);
...
function createIterableMethod(method, isReadonly6, isShallow3) {
    return function(...args) {
        ...
        !isReadonly6 && track(rawTarget, "iterate" /* TrackOpTypes.ITERATE */ , isKeyOnly ? MAP_KEY_ITERATE_KEY : ITERATE_KEY);
...
function createInstrumentationGetter(isReadonly7, shallow) {
    ...
    return (target, key, receiver)=>{
        if (key === "__v_isReactive" /* ReactiveFlags.IS_REACTIVE */ ) return !isReadonly7;
        else if (key === "__v_isReadonly" /* ReactiveFlags.IS_READONLY */ ) return isReadonly7;
...
function createReactiveObject(target, isReadonly8, baseHandlers, collectionHandlers, proxyMap) {
    ...
    if (target["__v_raw" /* ReactiveFlags.RAW */ ] && !(isReadonly8 && target["__v_isReactive" /* ReactiveFlags.IS_REACTIVE */ ])) return target;
...
class ComputedRefImpl {
    constructor(getter, _setter, isReadonly9, isSSR){
        ...
        this["__v_isReadonly" /* ReactiveFlags.IS_READONLY */ ] = isReadonly9;
    }
    get value() {
...
var _mainVue = require("./views/Main.vue");
var _mainVueDefault = parcelHelpers.interopDefault(_mainVue);
var _chordApplicatureVue = require("./views/ChordApplicature.vue");
var _chordApplicatureVueDefault = parcelHelpers.interopDefault(_chordApplicatureVue);
var _notFoundVue = require("./views/NotFound.vue");
var _notFoundVueDefault = parcelHelpers.interopDefault(_notFoundVue);
const router = (0, _vueRouter.createRouter)({
    history: (0, _vueRouter.createWebHistory)(),
    routes: [
        {
            path: "/",
            component: (0, _mainVueDefault.default)
        },
        {
            path: "/chord-applicature",
            component: (0, _chordApplicatureVueDefault.default)
        },
        {
            path: "/not-found",
            component: (0, _notFoundVueDefault.default)
        },
        {
            path: "/:catchAll(.*)",
            redirect: "/not-found"
...
},{"vue-router":"c18b3","./views/Main.vue":"3s1LB","./views/ChordApplicature.vue":"45hrs","./views/NotFound.vue":"bCqCp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"c18b3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
 ...
 */ function stringifyQuery(query) {
    ...
    for(let key in query){
        ...
        // keep null values
        const values = isArray(value1) ? value1.map((v)=>v && encodeQueryValue(v)) : [
 ...
 */ function createRouter(options) {
    ...
    function pushWithRedirect(to, redirectedFrom) {
        ...
        if (!force && isSameRouteLocation(stringifyQuery$1, from, targetLocation)) {
            failure1 = createRouterError(16 /* ErrorTypes.NAVIGATION_DUPLICATED */ , {
                to: toLocation,
                from
            });
        ...
        return (failure1 ? Promise.resolve(failure1) : navigate(toLocation, from)).catch((error)=>isNavigationFailure(error) ? isNavigationFailure(error, 2 /* ErrorTypes.NAVIGATION_GUARD_REDIRECT */ ) ? error : markAsReady(error) // also returns the error
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3s1LB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let script;
let initialize = ()=>{
    script = require("script:./Main.vue");
    if (script.__esModule) script = script.default;
    script.render = require("template:./Main.vue").render;
    require("custom:./Main.vue").default(script);
    script.__scopeId = "data-v-aea2a7";
    script.__file = "/Users/trabajo/Desktop/compose/src/views/Main.vue";
};
initialize();
if (module.hot) {
    script.__hmrId = "aea2a7-hmr";
    module.hot.accept(()=>{
        setTimeout(()=>{
            initialize();
            if (!__VUE_HMR_RUNTIME__.createRecord("aea2a7-hmr", script)) __VUE_HMR_RUNTIME__.reload("aea2a7-hmr", script);
        }, 0);
    });
}
exports.default = script;

},{"script:./Main.vue":"dwk0l","template:./Main.vue":"6rPnc","custom:./Main.vue":"bYsH4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dwk0l":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _vue = require("vue");
var _scaleTableVue = require("./../components/ScaleTable.vue");
var _scaleTableVueDefault = parcelHelpers.interopDefault(_scaleTableVue);
var _scaleSetting = require("./../components/ScaleSetting");
var _scaleSettingDefault = parcelHelpers.interopDefault(_scaleSetting);
var _scale = require("./../js/helpers/Scale");
var _scaleDefault = parcelHelpers.interopDefault(_scale);
var _uiCanvasVue = require("./../components/ui/UiCanvas.vue");
var _uiCanvasVueDefault = parcelHelpers.interopDefault(_uiCanvasVue);
exports.default = {
    __name: "Main",
    setup (__props, { expose  }) {
        ...
        const scale = (0, _vue.ref)(new (0, _scaleDefault.default)(DEFAULT_ROOT, DEFAULT_SCALE));
        const instrument = (0, _vue.ref)(DEFAULT_INSTRUMENT);
        const setRoot = (root)=>{
        ...
        const __returned__ = {
            ...
            setInstrument,
            ref: (0, _vue.ref),
            ScaleTable: (0, _scaleTableVueDefault.default),
            get ScaleSetting () {
                return 0, _scaleSettingDefault.default;
            },
            get Scale () {
                return 0, _scaleDefault.default;
            },
            UiCanvas: (0, _uiCanvasVueDefault.default)
        };
...
},{"vue":"gzxs9","./../components/ScaleTable.vue":"iKv94","./../components/ScaleSetting":"iTgbf","./../js/helpers/Scale":"6AgEa","./../components/ui/UiCanvas.vue":"fPLL8","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iKv94":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let script;
let initialize = ()=>{
    script = require("script:./ScaleTable.vue");
    if (script.__esModule) script = script.default;
    script.render = require("template:./ScaleTable.vue").render;
    require("custom:./ScaleTable.vue").default(script);
    script.__scopeId = "data-v-c3bb79";
    script.__file = "/Users/trabajo/Desktop/compose/src/components/ScaleTable.vue";
};
initialize();
if (module.hot) {
    script.__hmrId = "c3bb79-hmr";
    module.hot.accept(()=>{
        setTimeout(()=>{
            initialize();
            if (!__VUE_HMR_RUNTIME__.createRecord("c3bb79-hmr", script)) __VUE_HMR_RUNTIME__.reload("c3bb79-hmr", script);
        }, 0);
    });
}
exports.default = script;

},{"script:./ScaleTable.vue":"aEEdE","template:./ScaleTable.vue":"8fuRg","custom:./ScaleTable.vue":"bYBas","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aEEdE":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _romanizeNumbers = require("./../js/helpers/romanizeNumbers");
...
exports.default = {
    ...
    setup (__props, { expose  }) {
        ...
        const __returned__ = {
            get romanize () {
                return 0, _romanizeNumbersDefault.default;
            }
        };
        Object.defineProperty(__returned__, "__isScriptSetup", {
            enumerable: false,
...
},{"./../js/helpers/romanizeNumbers":"gsCYk","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gsCYk":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8fuRg":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "render", ()=>render);
var _vue = require("vue");
...
const _hoisted_5 = /*#__PURE__*/ (0, _vue.createElementVNode)("td", null, "Step:", -1 /* HOISTED */ );
const _hoisted_6 = {
    class: "scale__notes"
};
const _hoisted_7 = /*#__PURE__*/ (0, _vue.createElementVNode)("td", null, "Note:", -1 /* HOISTED */ );
function render(_ctx, _cache, $props, $setup, $data, $options) {
    return (0, _vue.openBlock)(), (0, _vue.createElementBlock)("div", _hoisted_1, [
        _hoisted_2,
        (0, _vue.createElementVNode)("table", _hoisted_3, [
            (0, _vue.createElementVNode)("tbody", null, [
                (0, _vue.createElementVNode)("tr", _hoisted_4, [
                    _hoisted_5,
                    ((0, _vue.openBlock)(true), (0, _vue.createElementBlock)((0, _vue.Fragment), null, (0, _vue.renderList)($props.scale, (_, index)=>{
                        return (0, _vue.openBlock)(), (0, _vue.createElementBlock)("td", null, (0, _vue.toDisplayString)($setup.romanize(index + 1)), 1 /* TEXT */ );
                    }), 256 /* UNKEYED_FRAGMENT */ ))
                ]),
                (0, _vue.createElementVNode)("tr", _hoisted_6, [
                    _hoisted_7,
                    ((0, _vue.openBlock)(true), (0, _vue.createElementBlock)((0, _vue.Fragment), null, (0, _vue.renderList)($props.scale, (note)=>{
                        return (0, _vue.openBlock)(), (0, _vue.createElementBlock)("td", null, (0, _vue.toDisplayString)(note), 1 /* TEXT */ );
                    }), 256 /* UNKEYED_FRAGMENT */ ))
                ])
            ])
        ])
...
if (module.hot) module.hot.accept(()=>{
    __VUE_HMR_RUNTIME__.rerender("c3bb79-hmr", render);
});

},{"vue":"gzxs9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bYBas":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let NOOP = ()=>{};
exports.default = (script)=>{};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iTgbf":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let script;
let initialize = ()=>{
    script = require("script:./ScaleSetting.vue");
    if (script.__esModule) script = script.default;
    script.render = require("template:./ScaleSetting.vue").render;
    require("custom:./ScaleSetting.vue").default(script);
    script.__scopeId = "data-v-ed928e";
    script.__file = "/Users/trabajo/Desktop/compose/src/components/ScaleSetting.vue";
};
initialize();
if (module.hot) {
    script.__hmrId = "ed928e-hmr";
    module.hot.accept(()=>{
        setTimeout(()=>{
            initialize();
            if (!__VUE_HMR_RUNTIME__.createRecord("ed928e-hmr", script)) __VUE_HMR_RUNTIME__.reload("ed928e-hmr", script);
        }, 0);
    });
}
exports.default = script;

},{"script:./ScaleSetting.vue":"cvzzq","template:./ScaleSetting.vue":"9uppX","custom:./ScaleSetting.vue":"gFabI","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cvzzq":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _rootNote = require("./RootNote");
var _rootNoteDefault = parcelHelpers.interopDefault(_rootNote);
var _uiCustomSelectVue = require("./ui/UiCustomSelect.vue");
var _uiCustomSelectVueDefault = parcelHelpers.interopDefault(_uiCustomSelectVue);
var _scales = require("./../js/data/scales");
var _scalesDefault = parcelHelpers.interopDefault(_scales);
var _instruments = require("./../js/data/instruments");
var _instrumentsDefault = parcelHelpers.interopDefault(_instruments);
exports.default = {
    __name: "ScaleSetting",
    props: {
        scale: Object
    ...
    setup (__props, { expose , emit  }) {
        ...
        const __returned__ = {
            ...
            instrumentUpdated,
            get RootNote () {
                return 0, _rootNoteDefault.default;
            },
            UiCustomSelect: (0, _uiCustomSelectVueDefault.default),
            get scales () {
                return 0, _scalesDefault.default;
            },
            get instruments () {
                return 0, _instrumentsDefault.default;
            }
        };
        Object.defineProperty(__returned__, "__isScriptSetup", {
            enumerable: false,
...
},{"./RootNote":"3jw9J","./ui/UiCustomSelect.vue":"c7kW3","./../js/data/scales":"huvKS","./../js/data/instruments":"3vTEn","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3jw9J":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let script;
let initialize = ()=>{
    script = require("script:./RootNote.vue");
    if (script.__esModule) script = script.default;
    script.render = require("template:./RootNote.vue").render;
    require("custom:./RootNote.vue").default(script);
    script.__scopeId = "data-v-a176d2";
    script.__file = "/Users/trabajo/Desktop/compose/src/components/RootNote.vue";
};
initialize();
if (module.hot) {
    script.__hmrId = "a176d2-hmr";
    module.hot.accept(()=>{
        setTimeout(()=>{
            initialize();
            if (!__VUE_HMR_RUNTIME__.createRecord("a176d2-hmr", script)) __VUE_HMR_RUNTIME__.reload("a176d2-hmr", script);
        }, 0);
    });
}
exports.default = script;

},{"script:./RootNote.vue":"fhL6I","template:./RootNote.vue":"bQdN1","custom:./RootNote.vue":"iFnu5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fhL6I":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
exports.default = {
    __name: "RootNote",
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bQdN1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "render", ()=>render);
var _vue = require("vue");
function render(_ctx, _cache, $props, $setup, $data, $options) {
    return (0, _vue.openBlock)(), (0, _vue.createElementBlock)("button", {
        class: (0, _vue.normalizeClass)([
            "select-root__item",
            {
                "active": $setup.isRootNote()
            }
        ]),
        onClick: _cache[0] || (_cache[0] = ($event)=>$setup.emit("rootnote-update", $props.note))
    }, (0, _vue.toDisplayString)($props.note.toUpperCase()), 3 /* TEXT, CLASS */ );
}
if (module.hot) module.hot.accept(()=>{
    __VUE_HMR_RUNTIME__.rerender("a176d2-hmr", render);
});

},{"vue":"gzxs9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iFnu5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let NOOP = ()=>{};
exports.default = (script)=>{};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"c7kW3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let script;
let initialize = ()=>{
    script = require("script:./UiCustomSelect.vue");
    if (script.__esModule) script = script.default;
    script.render = require("template:./UiCustomSelect.vue").render;
    script.__cssModules = require("style:./UiCustomSelect.vue").default;
    require("custom:./UiCustomSelect.vue").default(script);
    script.__scopeId = "data-v-e3ba5a";
    script.__file = "/Users/trabajo/Desktop/compose/src/components/ui/UiCustomSelect.vue";
};
initialize();
if (module.hot) {
    script.__hmrId = "e3ba5a-hmr";
    module.hot.accept(()=>{
        setTimeout(()=>{
            initialize();
            if (!__VUE_HMR_RUNTIME__.createRecord("e3ba5a-hmr", script)) __VUE_HMR_RUNTIME__.reload("e3ba5a-hmr", script);
        }, 0);
    });
}
exports.default = script;

},{"script:./UiCustomSelect.vue":"1W8HU","template:./UiCustomSelect.vue":"9hEcz","style:./UiCustomSelect.vue":"7yYYu","custom:./UiCustomSelect.vue":"4Ys99","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1W8HU":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _uiCustomSelectOptionVue = require("./UiCustomSelectOption.vue");
var _uiCustomSelectOptionVueDefault = parcelHelpers.interopDefault(_uiCustomSelectOptionVue);
var _vue = require("vue");
exports.default = {
    __name: "UiCustomSelect",
    props: {
        options: Array,
        value: Object
    },
    ...
    setup (__props, { expose , emit  }) {
        expose();
        const props = __props;
        const currentValue = (0, _vue.ref)(props.value ? props.value : props.options[0].name);
        const isActive = (0, _vue.ref)(false);
        const select = (0, _vue.ref)(null);
        const closeSelect = (e)=>{
            if (!select.value.contains(e.target)) isActive.value = false;
        };
        const toggleAcitve = ()=>{
        ...
        const __returned__ = {
            ...
            toggleAcitve,
            updateSelect,
            UiCustomSelectOption: (0, _uiCustomSelectOptionVueDefault.default),
            ref: (0, _vue.ref)
        };
        Object.defineProperty(__returned__, "__isScriptSetup", {
            enumerable: false,
...
},{"./UiCustomSelectOption.vue":"ezx41","vue":"gzxs9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ezx41":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let script;
let initialize = ()=>{
    script = require("script:./UiCustomSelectOption.vue");
    if (script.__esModule) script = script.default;
    script.render = require("template:./UiCustomSelectOption.vue").render;
    script.__cssModules = require("style:./UiCustomSelectOption.vue").default;
    require("custom:./UiCustomSelectOption.vue").default(script);
    script.__scopeId = "data-v-c8df50";
    script.__file = "/Users/trabajo/Desktop/compose/src/components/ui/UiCustomSelectOption.vue";
};
initialize();
if (module.hot) {
    script.__hmrId = "c8df50-hmr";
    module.hot.accept(()=>{
        setTimeout(()=>{
            initialize();
            if (!__VUE_HMR_RUNTIME__.createRecord("c8df50-hmr", script)) __VUE_HMR_RUNTIME__.reload("c8df50-hmr", script);
        }, 0);
    });
}
exports.default = script;

},{"script:./UiCustomSelectOption.vue":"iMPR3","template:./UiCustomSelectOption.vue":"4V52A","style:./UiCustomSelectOption.vue":"bY1XK","custom:./UiCustomSelectOption.vue":"aaNE2","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iMPR3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
exports.default = {
    __name: "UiCustomSelectOption",
    props: {
        option: Object
    },
    emits: [
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4V52A":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "render", ()=>render);
var _vue = require("vue");
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
    return (0, _vue.openBlock)(), (0, _vue.createElementBlock)("div", {
        class: "option",
        onClick: _cache[0] || (_cache[0] = ($event)=>_ctx.$emit("option-selected", $props.option))
    }, [
        ...
        (0, _vue.createElementVNode)("label", {
            for: $props.option.value
        }, (0, _vue.toDisplayString)($props.option.name), 9 /* TEXT, PROPS */ , _hoisted_2)
    ]);
}
if (module.hot) module.hot.accept(()=>{
    __VUE_HMR_RUNTIME__.rerender("c8df50-hmr", render);
});

},{"vue":"gzxs9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bY1XK":[function() {},{}],"aaNE2":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let NOOP = ()=>{};
exports.default = (script)=>{};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9hEcz":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "render", ()=>render);
var _vue = require("vue");
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
    return (0, _vue.openBlock)(), (0, _vue.createElementBlock)("div", {
        ...
        (0, _vue.createElementVNode)("div", {
            ...
            onClick: $setup.toggleAcitve
        }, (0, _vue.toDisplayString)($setup.currentValue ? $setup.currentValue : $props.options[0]), 1 /* TEXT */ ),
        (0, _vue.createElementVNode)("div", _hoisted_1, [
            ((0, _vue.openBlock)(true), (0, _vue.createElementBlock)((0, _vue.Fragment), null, (0, _vue.renderList)($props.options, (option)=>{
                return (0, _vue.openBlock)(), (0, _vue.createBlock)($setup["UiCustomSelectOption"], {
                    option: option,
                    onOptionSelected: $setup.updateSelect
                }, null, 8 /* PROPS */ , [
                    "option"
                ]);
            }), 256 /* UNKEYED_FRAGMENT */ ))
...
if (module.hot) module.hot.accept(()=>{
    __VUE_HMR_RUNTIME__.rerender("e3ba5a-hmr", render);
});

},{"vue":"gzxs9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7yYYu":[function() {},{}],"4Ys99":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let NOOP = ()=>{};
exports.default = (script)=>{};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"huvKS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const scales = [
    {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3vTEn":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const instruments = [
    {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9uppX":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "render", ()=>render);
var _vue = require("vue");
const _hoisted_1 = {
    class: "select-root select-wrapper"
};
const _hoisted_2 = /*#__PURE__*/ (0, _vue.createElementVNode)("span", {
    class: "select-root__title"
}, "Choose the root note", -1 /* HOISTED */ );
const _hoisted_3 = {
    class: "select-root__items"
};
const _hoisted_4 = {
    class: "select-root alter"
};
const _hoisted_5 = {
    class: "settings"
};
    ...
    return (0, _vue.openBlock)(), (0, _vue.createElementBlock)((0, _vue.Fragment), null, [
        (0, _vue.createElementVNode)("div", _hoisted_1, [
            ...
            (0, _vue.createElementVNode)("div", _hoisted_3, [
                ((0, _vue.openBlock)(true), (0, _vue.createElementBlock)((0, _vue.Fragment), null, (0, _vue.renderList)($setup.notes(), (note)=>{
                    return (0, _vue.openBlock)(), (0, _vue.createBlock)($setup["RootNote"], {
                        note: note,
                        root: $props.scale.root,
                        onRootnoteUpdate: ($event)=>$setup.emit("rootnote-update", note)
                    }, null, 8 /* PROPS */ , [
                        "note",
                        "root",
                        "onRootnoteUpdate"
            ...
            (0, _vue.createElementVNode)("div", _hoisted_4, [
                (0, _vue.createElementVNode)("button", {
                    class: (0, _vue.normalizeClass)([
                        "select-root__alter",
                        {
                            "active": $props.scale.isSharp
                        }
                    ]),
                    onClick: _cache[0] || (_cache[0] = ($event)=>$setup.isSharpUpdate(true))
                }, " Sharp ", 2 /* CLASS */ ),
                (0, _vue.createElementVNode)("button", {
                    class: (0, _vue.normalizeClass)([
                        "select-root__alter",
                    ...
                    onClick: _cache[1] || (_cache[1] = ($event)=>$setup.isSharpUpdate(false))
                }, " Flat ", 2 /* CLASS */ )
            ])
        ]),
        (0, _vue.createElementVNode)("div", _hoisted_5, [
            (0, _vue.createVNode)($setup["UiCustomSelect"], {
                options: $setup.scales,
                onSelect: $setup.scaleUpdated
            }, null, 8 /* PROPS */ , [
                "options"
            ]),
            (0, _vue.createVNode)($setup["UiCustomSelect"], {
                options: $setup.instruments,
                onSelect: $setup.instrumentUpdated
            }, null, 8 /* PROPS */ , [
                "options"
            ])
        ])
...
if (module.hot) module.hot.accept(()=>{
    __VUE_HMR_RUNTIME__.rerender("ed928e-hmr", render);
});

},{"vue":"gzxs9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gFabI":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let NOOP = ()=>{};
exports.default = (script)=>{};
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fPLL8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let script;
let initialize = ()=>{
    script = require("script:./UiCanvas.vue");
    if (script.__esModule) script = script.default;
    script.render = require("template:./UiCanvas.vue").render;
    require("custom:./UiCanvas.vue").default(script);
    script.__scopeId = "data-v-4d8e49";
    script.__file = "/Users/trabajo/Desktop/compose/src/components/ui/UiCanvas.vue";
};
initialize();
if (module.hot) {
    script.__hmrId = "4d8e49-hmr";
    module.hot.accept(()=>{
        setTimeout(()=>{
            initialize();
            if (!__VUE_HMR_RUNTIME__.createRecord("4d8e49-hmr", script)) __VUE_HMR_RUNTIME__.reload("4d8e49-hmr", script);
        }, 0);
    });
}
exports.default = script;

},{"script:./UiCanvas.vue":"gS2IR","template:./UiCanvas.vue":"b5kBp","custom:./UiCanvas.vue":"kW8nK","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gS2IR":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _guitarJs = require("../../js/helpers/Guitar.js");
var _guitarJsDefault = parcelHelpers.interopDefault(_guitarJs);
var _keyboardJs = require("../../js/helpers/Keyboard.js");
...
exports.default = {
    ...
    setup (__props, { expose  }) {
        ...
        (0, _vue.onMounted)(()=>{
            const canvas = (0, _vue.getCurrentInstance)().refs.canvas;
            guitar = new (0, _guitarJsDefault.default)(canvas);
            keyboard = new (0, _keyboardJsDefault.default)(canvas);
            render();
        });
        (0, _vue.watch)(()=>props.scale, ()=>{
        ...
        const __returned__ = {
            ...
            render,
            get Guitar () {
                return 0, _guitarJsDefault.default;
            },
            get Keyboard () {
                return 0, _keyboardJsDefault.default;
            },
...
},{"../../js/helpers/Guitar.js":"24o42","../../js/helpers/Keyboard.js":"3eMxX","vue":"gzxs9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"24o42":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Guitar {
    ...
    _defineIsSharp(scale) {
        const note1 = scale.find((note)=>note.length > 1);
        if (!note1) {
            this._setIsSharp(true);
            return;
        }
        this._setIsSharp(note1.split("")[1] === "#");
    }
    _getStrings() {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"b5kBp":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "render", ()=>render);
var _vue = require("vue");
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
    return (0, _vue.openBlock)(), (0, _vue.createElementBlock)("canvas", _hoisted_1, null, 512 /* NEED_PATCH */ );
}
if (module.hot) module.hot.accept(()=>{
    __VUE_HMR_RUNTIME__.rerender("4d8e49-hmr", render);
});

},{"vue":"gzxs9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kW8nK":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let NOOP = ()=>{};
exports.default = (script)=>{};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6rPnc":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "render", ()=>render);
var _vue = require("vue");
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
    return (0, _vue.openBlock)(), (0, _vue.createElementBlock)((0, _vue.Fragment), null, [
        (0, _vue.createElementVNode)("section", _hoisted_1, [
            (0, _vue.createVNode)($setup["ScaleSetting"], {
                scale: $setup.scale,
                onRootnoteUpdate: $setup.setRoot,
                onIsSharpUpdate: $setup.setIsSharp,
                onScaleTypeUpdate: $setup.setScaleType,
                onInstrumentUpdate: $setup.setInstrument
            }, null, 8 /* PROPS */ , [
                "scale"
            ])
        ]),
        (0, _vue.createElementVNode)("section", _hoisted_2, [
            (0, _vue.createVNode)($setup["ScaleTable"], {
                scale: $setup.scale.getScale()
            }, null, 8 /* PROPS */ , [
                "scale"
            ])
        ]),
        (0, _vue.createElementVNode)("section", _hoisted_3, [
            (0, _vue.createVNode)($setup["UiCanvas"], {
                scale: $setup.scale.getScale(),
...
if (module.hot) module.hot.accept(()=>{
    __VUE_HMR_RUNTIME__.rerender("aea2a7-hmr", render);
});

},{"vue":"gzxs9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bYsH4":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let NOOP = ()=>{};
exports.default = (script)=>{};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"45hrs":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let script;
let initialize = ()=>{
    script = require("script:./ChordApplicature.vue");
    if (script.__esModule) script = script.default;
    script.render = require("template:./ChordApplicature.vue").render;
    script.__cssModules = require("style:./ChordApplicature.vue").default;
    require("custom:./ChordApplicature.vue").default(script);
    script.__scopeId = "data-v-5cdd39";
    script.__file = "/Users/trabajo/Desktop/compose/src/views/ChordApplicature.vue";
};
initialize();
if (module.hot) {
    script.__hmrId = "5cdd39-hmr";
    module.hot.accept(()=>{
        setTimeout(()=>{
            initialize();
            if (!__VUE_HMR_RUNTIME__.createRecord("5cdd39-hmr", script)) __VUE_HMR_RUNTIME__.reload("5cdd39-hmr", script);
        }, 0);
    });
}
exports.default = script;

},{"script:./ChordApplicature.vue":"NqHm8","template:./ChordApplicature.vue":"gdnPd","style:./ChordApplicature.vue":"3ZJOJ","custom:./ChordApplicature.vue":"4oXi6","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"NqHm8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _vue = require("vue");
var _rootNoteVue = require("../components/RootNote.vue");
var _rootNoteVueDefault = parcelHelpers.interopDefault(_rootNoteVue);
var _uiCanvasVue = require("./../components/ui/UiCanvas.vue");
var _uiCanvasVueDefault = parcelHelpers.interopDefault(_uiCanvasVue);
var _chordJs = require("../js/helpers/Chord.js");
var _chordJsDefault = parcelHelpers.interopDefault(_chordJs);
exports.default = {
    __name: "ChordApplicature",
    setup (__props, { expose  }) {
        expose();
        const DEFAULT_ROOT = "C";
        const DEFAULT_TYPE = "major";
        const chord = new (0, _chordJsDefault.default)();
        const chordTypes = chord.getPatterns();
        const notes = (0, _vue.ref)(chord.getNotes());
        const root = (0, _vue.ref)(DEFAULT_ROOT);
        const currentChordType = (0, _vue.ref)(DEFAULT_TYPE);
        const currentChordNotes = (0, _vue.computed)(()=>{
        ...
        const __returned__ = {
            ...
            RootNote: (0, _rootNoteVueDefault.default),
            UiCanvas: (0, _uiCanvasVueDefault.default),
            get Chord () {
                return 0, _chordJsDefault.default;
            }
        };
        Object.defineProperty(__returned__, "__isScriptSetup", {
            enumerable: false,
...
},{"vue":"gzxs9","../components/RootNote.vue":"3jw9J","./../components/ui/UiCanvas.vue":"fPLL8","../js/helpers/Chord.js":"fw20S","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fw20S":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Chord {
    patterns = {
    ...
    calcDiatonic(scale, scaleName) {
        ...
        if (diatonicPattern) return diatonicPattern.map((item, index)=>`${scale[index]}${item}`);
        return [];
    }
}
exports.default = Chord;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gdnPd":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "render", ()=>render);
var _vue = require("vue");
const _withScopeId = (n)=>((0, _vue.pushScopeId)("data-v-5cdd39"), n = n(), (0, _vue.popScopeId)(), n);
const _hoisted_1 = {
    class: "container applicature"
};
const _hoisted_2 = /*#__PURE__*/ _withScopeId(()=>/*#__PURE__*/ (0, _vue.createElementVNode)("h2", {
        class: "applicature-title"
    }, "Chord Applicature", -1 /* HOISTED */ ));
const _hoisted_3 = {
    class: "applicature-root"
};
const _hoisted_4 = /*#__PURE__*/ _withScopeId(()=>/*#__PURE__*/ (0, _vue.createElementVNode)("h4", {
        class: "applicature-root__title"
    }, "Choose root:", -1 /* HOISTED */ ));
const _hoisted_5 = {
    class: "applicature-root__notes"
};
const _hoisted_6 = {
    class: "applicature-type"
};
const _hoisted_7 = /*#__PURE__*/ _withScopeId(()=>/*#__PURE__*/ (0, _vue.createElementVNode)("h4", {
        class: "applicature-type__title"
    }, "Choose chord type:", -1 /* HOISTED */ ));
const _hoisted_8 = {
    class: "applicature-type__types"
};
const _hoisted_9 = [
    "onClick"
];
    ...
    return (0, _vue.openBlock)(), (0, _vue.createElementBlock)("section", _hoisted_1, [
        ...
        (0, _vue.createElementVNode)("div", _hoisted_3, [
            ...
            (0, _vue.createElementVNode)("div", _hoisted_5, [
                ((0, _vue.openBlock)(true), (0, _vue.createElementBlock)((0, _vue.Fragment), null, (0, _vue.renderList)($setup.notes, (note)=>{
                    return (0, _vue.openBlock)(), (0, _vue.createBlock)($setup["RootNote"], {
                        onRootnoteUpdate: $setup.rootUpdate,
                        note: note,
                        root: $setup.root
                    }, null, 8 /* PROPS */ , [
                        "note",
        ...
        (0, _vue.createElementVNode)("div", _hoisted_6, [
            ...
            (0, _vue.createElementVNode)("div", _hoisted_8, [
                ((0, _vue.openBlock)(true), (0, _vue.createElementBlock)((0, _vue.Fragment), null, (0, _vue.renderList)($setup.chordTypes, (chordType)=>{
                    return (0, _vue.openBlock)(), (0, _vue.createElementBlock)("button", {
                        class: (0, _vue.normalizeClass)([
                            "applicature-type__type",
                            {
                                "active": $setup.currentChordType === chordType
                            }
                        ]),
                        onClick: ($event)=>$setup.chordTypeUpdate(chordType)
                    }, (0, _vue.toDisplayString)(chordType), 11 /* TEXT, CLASS, PROPS */ , _hoisted_9);
                }), 256 /* UNKEYED_FRAGMENT */ ))
            ])
        ]),
        (0, _vue.createVNode)($setup["UiCanvas"], {
            class: "applicature-chord",
            instrument: "piano",
            scale: $setup.currentChordNotes
        }, null, 8 /* PROPS */ , [
            "scale"
        ])
    ]);
...
if (module.hot) module.hot.accept(()=>{
    __VUE_HMR_RUNTIME__.rerender("5cdd39-hmr", render);
});

},{"vue":"gzxs9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3ZJOJ":[function() {},{}],"4oXi6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let NOOP = ()=>{};
exports.default = (script)=>{};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bCqCp":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let script;
let initialize = ()=>{
    script = {};
    script.render = require("template:./NotFound.vue").render;
    script.__cssModules = require("style:./NotFound.vue").default;
    require("custom:./NotFound.vue").default(script);
    script.__scopeId = "data-v-2251d3";
    script.__file = "/Users/trabajo/Desktop/compose/src/views/NotFound.vue";
};
initialize();
if (module.hot) {
    script.__hmrId = "2251d3-hmr";
    module.hot.accept(()=>{
        setTimeout(()=>{
            initialize();
            if (!__VUE_HMR_RUNTIME__.createRecord("2251d3-hmr", script)) __VUE_HMR_RUNTIME__.reload("2251d3-hmr", script);
        }, 0);
    });
}
exports.default = script;

},{"template:./NotFound.vue":"74qd1","style:./NotFound.vue":"55fbz","custom:./NotFound.vue":"SgoTq","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"74qd1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "render", ()=>render);
var _vue = require("vue");
...
const _hoisted_2 = /*#__PURE__*/ (0, _vue.createElementVNode)("h3", {
    class: "title"
}, "Oops...", -1 /* HOISTED */ );
const _hoisted_3 = /*#__PURE__*/ (0, _vue.createElementVNode)("h4", {
    class: "subtitle"
}, "This page does not seem to exist", -1 /* HOISTED */ );
const _hoisted_4 = [
    _hoisted_2,
    _hoisted_3
];
...
if (module.hot) module.hot.accept(()=>{
    __VUE_HMR_RUNTIME__.rerender("2251d3-hmr", render);
});

},{"vue":"gzxs9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"55fbz":[function() {},{}],"SgoTq":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let NOOP = ()=>{};
exports.default = (script)=>{};
...
let initialize = ()=>{
    ...
    script.__scopeId = "data-v-3e62a8";
    script.__file = "/Users/trabajo/Desktop/compose/src/App.vue";
};
initialize();
if (module.hot) {
    script.__hmrId = "3e62a8-hmr";
    module.hot.accept(()=>{
        setTimeout(()=>{
            initialize();
            if (!__VUE_HMR_RUNTIME__.createRecord("3e62a8-hmr", script)) __VUE_HMR_RUNTIME__.reload("3e62a8-hmr", script);
        }, 0);
    });
}
exports.default = script;
...
},{"./components/Header.vue":"jdTzi","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jdTzi":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let script;
let initialize = ()=>{
    ...
    script.__scopeId = "data-v-0a5d1f";
    script.__file = "/Users/trabajo/Desktop/compose/src/components/Header.vue";
};
initialize();
if (module.hot) {
    script.__hmrId = "0a5d1f-hmr";
    module.hot.accept(()=>{
        setTimeout(()=>{
            initialize();
            if (!__VUE_HMR_RUNTIME__.createRecord("0a5d1f-hmr", script)) __VUE_HMR_RUNTIME__.reload("0a5d1f-hmr", script);
        }, 0);
    });
}
exports.default = script;

},{"script:./Header.vue":"eFOse","template:./Header.vue":"2spPw","style:./Header.vue":"8VzSO","custom:./Header.vue":"BBOSj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eFOse":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _navigationVue = require("./Navigation.vue");
var _navigationVueDefault = parcelHelpers.interopDefault(_navigationVue);
exports.default = {
    __name: "Header",
    setup (__props, { expose  }) {
        expose();
        const __returned__ = {
            Navigation: (0, _navigationVueDefault.default)
        };
        Object.defineProperty(__returned__, "__isScriptSetup", {
            enumerable: false,
            value: true
...
},{"./Navigation.vue":"jgRPd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jgRPd":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let script;
let initialize = ()=>{
    script = require("script:./Navigation.vue");
    if (script.__esModule) script = script.default;
    script.render = require("template:./Navigation.vue").render;
    script.__cssModules = require("style:./Navigation.vue").default;
    require("custom:./Navigation.vue").default(script);
    script.__scopeId = "data-v-f074e7";
    script.__file = "/Users/trabajo/Desktop/compose/src/components/Navigation.vue";
};
initialize();
if (module.hot) {
    script.__hmrId = "f074e7-hmr";
    module.hot.accept(()=>{
        setTimeout(()=>{
            initialize();
            if (!__VUE_HMR_RUNTIME__.createRecord("f074e7-hmr", script)) __VUE_HMR_RUNTIME__.reload("f074e7-hmr", script);
        }, 0);
    });
}
exports.default = script;

},{"script:./Navigation.vue":"bkDgY","template:./Navigation.vue":"aU1Br","style:./Navigation.vue":"jvtCy","custom:./Navigation.vue":"jR1vR","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bkDgY":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _vue = require("vue");
exports.default = {
    ...
    setup (__props, { expose  }) {
        expose();
        const isMenuActive = (0, _vue.ref)(false);
        const menu = (0, _vue.ref)(null);
        const closeModal = (e)=>{
            if (!menu.value.contains(e.target)) toggleBurger();
        };
        const toggleBurger = ()=>{
...
},{"vue":"gzxs9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aU1Br":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "render", ()=>render);
var _vue = require("vue");
const _withScopeId = (n)=>((0, _vue.pushScopeId)("data-v-f074e7"), n = n(), (0, _vue.popScopeId)(), n);
const _hoisted_1 = /*#__PURE__*/ _withScopeId(()=>/*#__PURE__*/ (0, _vue.createElementVNode)("div", {
        class: "burger-line"
    }, null, -1 /* HOISTED */ ));
const _hoisted_2 = /*#__PURE__*/ _withScopeId(()=>/*#__PURE__*/ (0, _vue.createElementVNode)("div", {
        class: "burger-line"
    }, null, -1 /* HOISTED */ ));
const _hoisted_3 = /*#__PURE__*/ _withScopeId(()=>/*#__PURE__*/ (0, _vue.createElementVNode)("div", {
        class: "burger-line"
    }, null, -1 /* HOISTED */ ));
const _hoisted_4 = [
    _hoisted_1,
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return (0, _vue.openBlock)(), (0, _vue.createElementBlock)("div", {
        ...
        (0, _vue.createElementVNode)("div", {
            class: "burger",
            onClick: $setup.toggleBurger
        }, _hoisted_4),
        (0, _vue.createElementVNode)("ul", _hoisted_5, [
            (0, _vue.createElementVNode)("li", _hoisted_6, [
                (0, _vue.createVNode)(_component_router_link, {
                    ...
                    default: (0, _vue.withCtx)(()=>[
                            (0, _vue.createTextVNode)(" Main ")
                        ]),
                    _: 1 /* STABLE */ 
                })
            ]),
            (0, _vue.createElementVNode)("li", _hoisted_7, [
                (0, _vue.createVNode)(_component_router_link, {
                    class: "nav-menu__item-link",
                    ...
                    default: (0, _vue.withCtx)(()=>[
                            (0, _vue.createTextVNode)(" Chord Applicatures ")
                        ]),
                    _: 1 /* STABLE */ 
                })
            ])
...
if (module.hot) module.hot.accept(()=>{
    __VUE_HMR_RUNTIME__.rerender("f074e7-hmr", render);
});

},{"vue":"gzxs9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jvtCy":[function() {},{}],"jR1vR":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let NOOP = ()=>{};
exports.default = (script)=>{};
...
parcelHelpers.export(exports, "render", ()=>render);
var _vue = require("vue");
const _withScopeId = (n)=>((0, _vue.pushScopeId)("data-v-0a5d1f"), n = n(), (0, _vue.popScopeId)(), n);
const _hoisted_1 = {
    class: "container"
};
const _hoisted_2 = /*#__PURE__*/ _withScopeId(()=>/*#__PURE__*/ (0, _vue.createElementVNode)("h1", {
        class: "title"
    }, "compose.io", -1 /* HOISTED */ ));
function render(_ctx, _cache, $props, $setup, $data, $options) {
    return (0, _vue.openBlock)(), (0, _vue.createElementBlock)("header", null, [
        (0, _vue.createElementVNode)("div", _hoisted_1, [
            (0, _vue.createVNode)($setup["Navigation"]),
            _hoisted_2
        ])
    ]);
}
if (module.hot) module.hot.accept(()=>{
    __VUE_HMR_RUNTIME__.rerender("0a5d1f-hmr", render);
});

},{"vue":"gzxs9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8VzSO":[function() {},{}],"BBOSj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let NOOP = ()=>{};
exports.default = (script)=>{};
...
if (module.hot) module.hot.accept(()=>{
    __VUE_HMR_RUNTIME__.rerender("3e62a8-hmr", render);
});
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["8TtF2","gLLPy"], "gLLPy", "parcelRequiref233")
